...
function torbutton_init() {
    ...
    // On Desktop, updateAllOpenPages is called by the torbutton_init_user_manual_links,
    // however, on mobile, we don't show any manual link, so the method is not called. Thus
